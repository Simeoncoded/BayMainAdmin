    ...
    return (
        <div>
            ...
            <main>
                ...
                <div className={styles.messagesServicesContainer}>
                    <EmpMessagesServices messages={messages} services={services} />
                </div>

                <div className={styles.quickServiceContainer}>
                    <h2 className={styles.recentH3}>Quick Service</h2>
                    <div className={styles.qCols}>
                        <div>
                            <button className={styles.Qbtn}>All Messages</button>
                        </div>
                        <div>
                            <button className={styles.Qbtn}>All Services</button>
                        </div>
                        <div className={styles.dContent}>
